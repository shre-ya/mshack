            ...
            <StylesProvider injectFirst>
                <div style={{ padding: "1rem", }}>
                    ...
                    <div style={{ marginTop: "2rem" }} className="filters">
                        ...
                        <div style={{ textAlign: "center", color: "black", marginTop: "0.5rem", marginBottom: "0.5rem" }} >Distance within</div>
                        <p>
                            <label>
                                <input type="checkbox" name='distance' value="2km"
                                    checked={this.state.distance.includes("2km")}
                            ...
                            <label>
                                <input type="checkbox" name='distance' value="5km"
                                    checked={this.state.distance.includes("5km")}
                                    onChange={this.batchChangeHandler}
                                />
                                <span>5km</span>
                            </label>
                            <br />
                            <label>
                                <input type="checkbox" name='distance' value="10km"
                                    checked={this.state.distance.includes("10km")}
                                    onChange={this.batchChangeHandler}
                                />
                                <span>10km</span>
                            </label>&nbsp;&nbsp;&nbsp;
                            <label>
                                <input type="checkbox" name='distance' value="20km"
                                    checked={this.state.distance.includes("20km")}
                                    onChange={this.batchChangeHandler}
                                />
                                <span>20km</span>
                            </label>
