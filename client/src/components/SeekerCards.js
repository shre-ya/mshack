                            ...
                            <div className="jobcard">
                                <div style={{ marginTop: "0.5rem", paddingLeft: "1rem", paddingRight: "1rem" }} >
                                    ...
                                    <div className="card-content" style={{ paddingLeft: "0.5rem" }}>
                                        ...
                                        <p style={{ marginTop: "0.5rem", color: "black" }}><span style={{ color: "grey" }}><b>Posted By:</b>&nbsp;</span> {this.getPostedbyName(job.postedBy)}&nbsp;&nbsp;({z} rating)</p>
                                    </div>
                                    <Apply active={this.state.apply} apply={this.apply} />
